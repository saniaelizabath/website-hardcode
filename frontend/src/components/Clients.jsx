...
const Clients = () => {
  ...
  return (
    <section className="relative pt-20 pb-12 sm:py-24 bg-gradient-to-b from-slate-50 to-blue-50 overflow-hidden">
      {/* Decorative Background Elements */}
      <div className="absolute inset-0 opacity-5">
        <div className="absolute top-0 left-0 w-96 h-96 bg-blue-400 rounded-full blur-3xl"></div>
        <div className="absolute bottom-0 right-0 w-96 h-96 bg-cyan-400 rounded-full blur-3xl"></div>
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-6 relative z-10">
        ...
        <div className="text-center mb-12 sm:mb-16 lg:mb-20">
          <h2 
            className="text-3xl sm:text-5xl md:text-6xl font-light text-slate-800 mb-3 sm:mb-4 tracking-wide" 
          ...
          <p 
            className="text-slate-600 text-base sm:text-lg max-w-2xl mx-auto mt-5 sm:mt-8 font-light" 
            style={{ fontFamily: 'Georgia, serif' }}
          >
            Trusted partnerships with leading organizations
          </p>
        ...
        <div className="relative mb-8 sm:mb-12 overflow-hidden">
          <div className="flex gap-6 sm:gap-12 animate-scroll-left">
            {[...clientsRow1, ...clientsRow1].map((client, index) => (
              <div
                key={index}
                className="flex-shrink-0 w-36 h-24 sm:w-48 sm:h-32 bg-white rounded-xl sm:rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 p-4 sm:p-6 flex items-center justify-center group hover:scale-110 border border-slate-200"
              >
                <img
                  src={client.logo}
                  alt={client.name}
        ...
        {/* Infinite Scrolling Row 2 - Right to Left */}
        <div className="relative overflow-hidden mb-12 sm:mb-0">
          <div className="flex gap-6 sm:gap-12 animate-scroll-right">
            {[...clientsRow2, ...clientsRow2].map((client, index) => (
              <div
                key={index}
                className="flex-shrink-0 w-36 h-24 sm:w-48 sm:h-32 bg-white rounded-xl sm:rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 p-4 sm:p-6 flex items-center justify-center group hover:scale-110 border border-slate-200"
        ...
        {/* Stats Section */}
        <div className="mt-16 sm:mt-24 grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-8 max-w-5xl mx-auto">
          <div className="text-center group">
            <div 
              className="text-3xl sm:text-5xl font-light text-blue-700 mb-2 sm:mb-3 group-hover:scale-110 transition-transform" 
              style={{ fontFamily: 'Georgia, serif' }}
            >
              50<span className="text-blue-500">+</span>
            </div>
            <div className="text-slate-600 text-xs sm:text-sm uppercase tracking-widest font-light">
              Active Clients
            </div>
          </div>
          <div className="text-center group">
